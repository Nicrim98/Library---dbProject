    ...
    if request.method == 'POST':
        ...
        if(authorizedUser != []):
            ...
            if authorizedUser[0][1] == us_name:
                ...
                print("loggowanie user id : " + str(log_us_id[0]))
                btaken = 0
                ...
                if(taken != []):
                    ...
                    for data in taken:
                        ...
                        if log_b_id[0] == (book_id[indicator]):
                            btaken += 1
                        indicator += 1    
                    if btaken > 0:
                        ### zawsze tu wchodzi ..............................
                    ...
                    cur.execute("INSERT INTO wypozyczenia (id_czytelnika, id_ksiazki, tytul, data_wypozyczenia, data_oddania) values ('" + log_us_id[0] + "'," + "'" + log_b_id[0] + "'," + "'" + log_title[0] + "'," +  "'2020-02-11','2020-03-12')")
